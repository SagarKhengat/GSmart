...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
	...
	private RuntimeExceptionDao<Retailer, Integer> retailerDao= null;
...
//			db.enableWriteAheadLogging();
			...
			TableUtils.createTable(connectionSource, Retailer.class);
			...
			int oldVersion, int newVersion)
	{
		try {
			...
			TableUtils.dropTable(connectionSource, Retailer.class, true);
	...
	public RuntimeExceptionDao<Retailer, Integer> getRetailerDao() {
		if (retailerDao == null) {
			retailerDao = getRuntimeExceptionDao(Retailer.class);
		}
		return retailerDao;
	}
